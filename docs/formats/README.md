...
| Map Data | .rgm | yes | `.glb` + metadata `.json` + per-actor `.soup`/`.json` scripts | [RGM.md](RGM.md) | Game map files containing sections for objects, scripts, locations, collisions, etc. |
